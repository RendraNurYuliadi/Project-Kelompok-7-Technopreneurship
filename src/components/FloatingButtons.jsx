...
export default function FloatingButtons(){
  return (
    <>
      ...
      <a href="https://wa.me/6281292731092" target="_blank" rel="noreferrer" className="fixed right-6 bottom-6 z-[999] w-12 h-12 rounded-full glass flex items-center justify-center hover:scale-105 transition-shadow" title="Chat with us">
